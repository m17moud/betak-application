...
class ApiConstants {
  ...
  // Client SignUp
  static String get clientSignUp =>
      dotenv.env['CLIENT_SIGN_UP'] ?? 'default_path';
  static String get clientSignUpPKey =>
      dotenv.env['CLIENT_SIGN_UP_PKEY'] ?? 'default_pkey';

  // Client SignIn
  static String get clientSignIn =>
      dotenv.env['CLIENT_SIGN_IN'] ?? 'default_path';
  static String get clientSignInPKey =>
      dotenv.env['CLIENT_SIGN_IN_PKEY'] ?? 'default_pkey';

  // Merchant SignUp
  static String get merchantSignUp =>
      dotenv.env['MERCHANT_SIGN_UP'] ?? 'default_path';
  static String get merchantSignUpPKey =>
      dotenv.env['MERCHANT_SIGN_UP_PKEY'] ?? 'default_pkey';

  // Merchant SignIn
  static String get merchantSignIn =>
      dotenv.env['MERCHANT_SIGN_IN'] ?? 'default_path';
  static String get merchantSignInPKey =>
      dotenv.env['MERCHANT_SIGN_IN_PKEY'] ?? 'default_pkey';
  ...
  static String get addProductPKey =>
      dotenv.env['ADD_PRODUCT_PKEY'] ?? 'default_pkey';

  // Select Products
  static String get selectProducts =>
      dotenv.env['SELECT_PRODUCTS'] ?? 'default_path';
  static String get selectProductsPKey =>
      dotenv.env['SELECT_PRODUCTS_PKEY'] ?? 'default_pkey';

  // Update Products
  static String get updateProducts =>
      dotenv.env['UPDATE_PRODUCTS'] ?? 'default_path';
  static String get updateProductsPKey =>
      dotenv.env['UPDATE_PRODUCTS_PKEY'] ?? 'default_pkey';
  static String get updateProductsTP =>
      dotenv.env['UPDATE_PRODUCTS_TP'] ?? 'default_pkey';

  // Delete Products
  static String get deleteProducts =>
      dotenv.env['DELETE_PRODUCTS'] ?? 'default_path';
  static String get deleteProductsPKey =>
      dotenv.env['DELETE_PRODUCTS_PKEY'] ?? 'default_pkey';
  static String get deleteProductsTP =>
      dotenv.env['DELETE_PRODUCTS_TP'] ?? 'default_pkey';

  // Add Like
  static String get addLike => dotenv.env['ADD_LIKE'] ?? 'default_path';
  static String get addLikePKey =>
      dotenv.env['ADD_LIKE_PKEY'] ?? 'default_pkey';

  // Check Like
  static String get checkLike => dotenv.env['CHECK_LIKE'] ?? 'default_path';
  static String get checkLikePKey =>
      dotenv.env['CHECK_LIKE_PKEY'] ?? 'default_pkey';

  // Logout
  static String get logout => dotenv.env['LOGOUT'] ?? 'default_path';
  static String get logoutPKey => dotenv.env['LOGOUT_PKEY'] ?? 'default_pkey';
  static String get logoutSellerTP =>
      dotenv.env['LOGOUT_SELLER_TP'] ?? 'default_path';
  static String get logoutCustomerTP =>
      dotenv.env['LOGOUT_CUSTOMER_TP'] ?? 'default_pkey';

// Check Session
  static String get checkSession =>
      dotenv.env['CHECK_SESSION'] ?? 'default_path';

  static String get checkSessionPKey =>
      dotenv.env['CHECK_SESSION_PKEY'] ?? 'default_pkey';
  static String get checkSessionSellerTP =>
      dotenv.env['CHECK_SESSION_SELLER_TP'] ?? 'default_path';
  ...
  static String get errorMessage =>
      dotenv.env['ERROR_MESSAGE'] ?? 'default_error_message';
  ...
  static String get confirmPassword =>
      dotenv.env['CONFIRM_PASSWORD'] ?? 'default_confirm_password';
